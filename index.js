...
function removeFlavorByName(inArray, flavor) {
...
function copy(inArray, outArray) {
...
function filterByWord(inArray, keyword) {
    var newArray = [];
    for (let i = 0; i < inArray.length; i++) {
        if (inArray[i].toLowerCase().includes(keyword)) {
